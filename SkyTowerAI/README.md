...
> Stan: 30.07.2026 · 691 testów · uruchamianie i operacje: [RUNBOOK.md](RUNBOOK.md) ·
...
```bash
# Pełny zestaw testów (691, ~19 s) — z katalogu SkyTowerAI/
...
`START.bat` (launcher), `RUNBOOK.md` (operacje), `tests/` (691 testów).
