...
> Stan: 30.07.2026 · 696 testów · uruchamianie i operacje: [RUNBOOK.md](RUNBOOK.md) ·
...
```bash
# Pełny zestaw testów (696, ~19 s) — z katalogu SkyTowerAI/
...
`START.bat` (launcher), `RUNBOOK.md` (operacje), `tests/` (696 testów).
