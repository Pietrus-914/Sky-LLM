...
State: server **4.1.0**, **661 tests green** (30.07.2026), running natively on Windows. Active branch `gpt_review` (see `GPT_REVIEW_PLAN.md`). Docs wiki: `../wiki/index.md`.
...
├── tests/                        # 661 tests: unit/ integration/ e2e/ (pytest)
...
python\venv\Scripts\python.exe -m pytest -q   # run tests (661, ~17 s)
```
